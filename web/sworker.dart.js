// Generated by dart2js (fast startup emitter, strong, CSP), the Dart to JavaScript compiler version: 2.12.2.
...
(function dartProgram() {
  ...
  O = {
    installSW: function($event) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.dynamic),
        cs, t1, $async$temp1;
      var $async$installSW = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1.toString;
              $async$goto = 2;
              return P._asyncAwait(t1, $async$installSW);
            case 2:
              // returning from await.
              cs = $async$result;
              P.print("Service worker installed");
              $async$temp1 = type$.JsObject;
              $async$goto = 3;
              return P._asyncAwait(P.promiseToFuture(cs.open("offline"), type$.dynamic), $async$installSW);
            case 3:
              // returning from await.
              $async$temp1._as($async$result).callMethod$2("addAll", ["offline.html"]);
              P.print("Offline data cached");
              // implicit return
              return P._asyncReturn(null, $async$completer);
          }
      });
      return P._asyncStartSync($async$installSW, $async$completer);
    },
    main: function() {
      P.print("Starting service worker");
      J._addEventListener$3$x(type$.ServiceWorkerGlobalScope._as(self).self, "install", type$.nullable_dynamic_Function_Event._as(O.sworker__installSW$closure()), null);
    }
  };
  ...
  P.promiseToFuture_closure0.prototype = {
    call$1: function(e) {
      return this.completer.completeError$1(type$.Object._as(e));
    },
    $signature: 1
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_1(O, "sworker__installSW$closure", "installSW", 1);
  })();
  (function inheritance() {
    var _inherit = hunkHelpers.inherit,
      _inheritMany = hunkHelpers.inheritMany;
    _inherit(P.Object, null);
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, H.TypeErrorDecoder, H.NullThrownFromJavaScriptException, H.ExceptionAndStackTrace, H._StackTrace, H.Closure, H.Rti, H._FunctionParameters, P._TimerImpl, P._AsyncAwaitCompleter, P.AsyncError, P._Completer, P._FutureListener, P._Future, P._AsyncCallbackEntry, P._StreamIterator, P._Zone, P.StackOverflowError, P._Exception, P.Null, P._StringStackTrace, P.StringBuffer]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString, W.DomException, W.Event, W.EventTarget]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      ServiceWorkerGlobalScope: findType("ServiceWorkerGlobalScope"),
...
//# sourceMappingURL=sworker.dart.js.map
