...
cd $CNOTES_DART_HOME
cp $CNOTES_READER_HOME/downloads/cnotes_zh_en_dict.json $EXT_HOME/chinesenotes_words.json
cp $CNOTES_READER_HOME/downloads/modern_named_entities.json $EXT_HOME/.
$DART_HOME/bin/dart2js --csp -o $EXT_HOME/main.dart.js web/main.dart
$DART_HOME/bin/dart2js --csp -o $EXT_HOME/serviceworker_ext.dart.js web/serviceworker_ext.dart
$DART_HOME/bin/dart2js --csp -o $EXT_HOME/content.dart.js web/content.dart
cd $EXT_HOME
